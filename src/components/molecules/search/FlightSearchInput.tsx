  ...
  return (
    ...
    >
      ...
      {isOpen && filteredData.length > 0 && (
        <div
          className="shadow-light-shadow transition-[opacity] ease-in duration-300 bg-white w-full absolute left-0 overflow-y-scroll h-fit top-full mt-1 z-20 border rounded-md border-[#E6E6E8]"
          role="listbox"
          id={listboxId}
        >
          {filteredData.map((d, index) => {
            ...
            return (
              <div
                key={index}
                className={`flex flex-row justify-between border-b border-[#E6E6E8] cursor-pointer px-3.5 py-3 ${
                  isSelected
