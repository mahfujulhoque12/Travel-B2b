...
const FlightSearchForRoundTripForm = ({ terminals, isModifySearch }: Props) => {
  ...
  // Update travel class
  const handleTravelClassSelect = useCallback((selectedClass: string) => {
    setFormData((prev) => ({
      ...prev,
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-2 gap-5">
          {/* Location Inputs */}
          <FlightSearchInput
            name="from"
            title="From"
...
export default FlightSearchForRoundTripForm;
